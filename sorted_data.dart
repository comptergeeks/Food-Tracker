      ...
      child: Container(
        ...
        child: StreamBuilder<QuerySnapshot>(
            stream: FirebaseFirestore.instance
                ...
                .collection('foodData').where('allergy', isEqualTo: context.read<IndexToSave>().indexNew).snapshots(),
            ...
            builder: (context, snapshot) {
              ...
              return ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    //print(context.read<IndexToSave>().indexNew);
                    if(data.docs[index]['allergy'] == context.read<IndexToSave>().indexNew) {
                      return CupertinoListTile(
                        trailing: returnIcon(context
                            .read<IndexToSave>()
                            .indexNew),
                        title: Text('${data.docs[index]['food']}'),
                        subtitle: Text(data.docs[index]['allergy'].toString()),
                      );
                    }
                    return Align(
                      alignment: Alignment.center,
